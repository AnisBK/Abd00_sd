...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '410437635970957322') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '410437635970957322') return;
...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NTU1ODYxOTA1NDM3MzYwMTYw.XSn6rw.aKLHPRIWS1HlXn6Fz09j_SVBl3s'; // التوكن هنا بس
      if(message.content === '!restart') {
if(message.author.id !== '410437635970957322') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
...
client.on("message", message => {
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('⚠ | **ليس لديك صلاحيات**');
      ...
      message.channel.sendMessage("", {embed: {
        ...
        footer: {
          text: "AnisBK.bot" // غير هنا حط اسم البوت
        }
...
.setFooter(message.author.username, message.author.avatarURL)  
 ...
 client.on('message', message => {
    ...
    client.guilds.get("555861905437360160").members.get("410437635970957322").sendMessage(message.author.tag+"\n Message : "+args)
...
client.login('NTU1ODYxOTA1NDM3MzYwMTYw.XSn6rw.aKLHPRIWS1HlXn6Fz09j_SVBl3s'); 
